      ...
      <div class="pswp__ui pswp__ui--hidden">
        <div class="pswp__top-bar">
          ...
          <span class="rotation-wrapper">
            <i v-if="options.rotationOn" @click="rotate(-90)">rotate_left</i>
            <i v-if="options.rotationOn" @click="rotate(90)">rotate_right</i>
          </span>
...
export default {
  ...
  methods: {
    ...
    // This remove default behaviour on scrolling
    // Reactivate this if you want customize this behaviour
    // onMouseWheel (e) {
    //   let ratio = 1.4
    //   if (e.deltaY > 0) {
    //     ratio = 1 / ratio
